...
Base.@kwdef struct TetrisConfig
    ...
    gradient_threshold::Float64 = 1e-2 # this is a filter - remove operators with gradient < this
    score_stopper_threshold::Float64 = 1e-2 # this is a termination condition - stop if score < this
