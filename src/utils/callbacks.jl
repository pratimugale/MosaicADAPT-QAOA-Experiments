...
function (stopper::ApproxRatioStopper)(
    ...
    @info "ApproxRatioStopper: tetris_pct=$(round(tetris_percent, digits=4)), gurobi_pct=$(round(stopper.gurobi_percent_satisfied_threshold, digits=4)), ratio=$(round(approx_ratio, digits=4))"
